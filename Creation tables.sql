...
(IdCredential INT CONSTRAINT PK_Credential PRIMARY KEY IDENTITY(1,1) NOT NULL,
...
(IdPlan TINYINT CONSTRAINT PK_Plan PRIMARY KEY NOT NULL,
...
CREATE TABLE Client
(IdClient INT CONSTRAINT PK_Client PRIMARY KEY IDENTITY(1,1) NOT NULL,
...
(IdSignature INT CONSTRAINT PK_Signature PRIMARY KEY IDENTITY(1,1) NOT NULL,
...
(IdBills INT CONSTRAINT PK_Bills PRIMARY KEY IDENTITY(1,1) NOT NULL,
