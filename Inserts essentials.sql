...
INSERT INTO Origin(IdOrigin,Description,Active,CreationDate,ChangeDate,CreationUser,ChangeUser)VALUES(1,'Pagamento',1,GETDATE(),GETDATE(),'marcos.camargo','marcos.camargo');
INSERT INTO Origin(IdOrigin,Description,Active,CreationDate,ChangeDate,CreationUser,ChangeUser)VALUES(2,'Benefício',1,GETDATE(),GETDATE(),'marcos.camargo','marcos.camargo');
INSERT INTO Origin(IdOrigin,Description,Active,CreationDate,ChangeDate,CreationUser,ChangeUser)VALUES(3,'Auxílio',1,GETDATE(),GETDATE(),'marcos.camargo','marcos.camargo');
INSERT INTO Origin(IdOrigin,Description,Active,CreationDate,ChangeDate,CreationUser,ChangeUser)VALUES(4,'Bonificação',1,GETDATE(),GETDATE(),'marcos.camargo','marcos.camargo');
INSERT INTO Origin(IdOrigin,Description,Active,CreationDate,ChangeDate,CreationUser,ChangeUser)VALUES(5,'Investimento',1,GETDATE(),GETDATE(),'marcos.camargo','marcos.camargo');
INSERT INTO Origin(IdOrigin,Description,Active,CreationDate,ChangeDate,CreationUser,ChangeUser)VALUES(6,'Consumo Diario',1,GETDATE(),GETDATE(),'marcos.camargo','marcos.camargo');
INSERT INTO Origin(IdOrigin,Description,Active,CreationDate,ChangeDate,CreationUser,ChangeUser)VALUES(7,'Alimentação',1,GETDATE(),GETDATE(),'marcos.camargo','marcos.camargo');
INSERT INTO Origin(IdOrigin,Description,Active,CreationDate,ChangeDate,CreationUser,ChangeUser)VALUES(8,'Aquisição',1,GETDATE(),GETDATE(),'marcos.camargo','marcos.camargo');
INSERT INTO Origin(IdOrigin,Description,Active,CreationDate,ChangeDate,CreationUser,ChangeUser)VALUES(9,'Cobrança Periódica',1,GETDATE(),GETDATE(),'marcos.camargo','marcos.camargo');
